...
public class KomodoJSONRPCClientTest {

    class MyClientTest extends KomodoJSONRPCClient {
        ...
        public Object query(String method, Object... o) throws KomodoRpcException {
            if(method!=expectedMethod) {
                throw new KomodoRpcException("wrong method");
            }
            if(o.equals(expectedObject)){
                throw new KomodoRpcException("wrong object");
            }
    ...
    public void signRawTransactionTest() throws Exception {
        client = new MyClientTest(false, "signrawtransaction", null,
                                    "{\n" +
                                            ...
                                            "  \"complete\": true\n" +
                                            "}\n");
        LinkedList<KomododRpcClient.ExtendedTxInput> inputList = new LinkedList<KomododRpcClient.ExtendedTxInput>();
